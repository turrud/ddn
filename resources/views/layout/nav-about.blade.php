  ...
  <div class="row ">
    <div class="col navbar">
      <ul class="list-group navbar-nav">
        <li class="list-group-item nav-item"><a class="nav-link" href="{{ route('profile') }}" {{ Request::is('profile') ? 'active' : '' }}">Profile</a></li>

        <li class="list-group-item nav-item"><a class="nav-link" href="{{ route('people') }}" {{ Request::is('about/people') ? 'active' : '' }}">People</a></li>
        <li class="list-group-item nav-item"><a class="nav-link" href="{{ route('designMethod') }}" {{ Request::is('about/designMethod') ? 'active' : '' }}">Design Method</a></li>
      </ul>
    </div>
    <div class="col navbar">
      <ul class="list-group navbar-nav">
